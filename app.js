// app.js — versión estable con edición por fila + Firebase
// Mantiene diseño/estructura. Agrega categorías “Equipos” y “Materiales” a Gastos Diarios,
// mantiene ATH Móvil y Cheque, balance correcto y sincronización en la nube.
...
/* ===================== Catálogos ===================== */
// Gastos Diarios — añade “Equipos” y “Materiales”
...
// Métodos (incluye ATH Móvil y Cheque)
...
function initCatalogs(){
  ...
  safely(()=> upsertOptions($('#expMethod'), ["Efectivo","Tarjeta","Transferencia","ATH Móvil","Cheque"]));
  safely(()=> upsertOptions($('#incMethod'), INCOME_METHODS));
}
