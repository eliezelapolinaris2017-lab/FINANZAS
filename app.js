// app.js — App de Finanzas con Firebase (Auth + Firestore) + balance completo + catálogos ampliados
// Incluye: Gastos Personales + Pagos + Ordinarios en balance y reportes
// Añadido: categorías extra en Gastos Diarios, métodos ATH Móvil y Cheque en Entradas (y Gastos si aplica)
...
/* ===================== Catálogos (categorías y métodos) ===================== */
...
function initCatalogs(){
  upsertOptions(document.getElementById('expCategory'), EXPENSE_CATEGORIES);
  upsertOptions(document.getElementById('expMethod'), ["Efectivo","Tarjeta","Transferencia","ATH Móvil","Cheque"]);
  upsertOptions(document.getElementById('incMethod'), INCOME_METHODS);
}
...
self.app = {
  ...
  state, saveLocal: ()=> save({skipCloud:true}),
