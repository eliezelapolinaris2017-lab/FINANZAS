...
/* ===================== Estado / Utils ===================== */
const STORAGE_KEY = 'finanzas-state-v7';
...
const DEFAULT_STATE = {
  ...
  reconciliations: [], // {id,date,bank,app,diff,note}
  _cloud: { updatedAt: 0 }
};
...
/* view: 'expenses','incomes','payments','ordinary','personal','invoices','quotes','reconciliations','reports'
   optionalId: para PDF individual de factura/cotización */
