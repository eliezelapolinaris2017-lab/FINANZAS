// app.js — App de Finanzas (Firebase + edición por fila en TODA la app)
// Incluye: balance correcto, catálogos (Equipos / Materiales, ATH Móvil / Cheque), y CRUD con Editar/Eliminar
...
// Gastos Diarios — incluye Equipos y Materiales (separados)
...
function applyTheme(){
  ...
  // Fallback logo si assets/logo.png falta
...
self.app = {
  ...
  setAutosync: (v)=> { cloud.autosync=!!v; localStorage.setItem('autosync', JSON.stringify(cloud.autosync)); uiCloud(); },
  state,
